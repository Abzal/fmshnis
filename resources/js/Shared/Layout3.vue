                ...
                <div class="row align-items-center">
                    <div class="col-xl-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar justify-content-md-end" id="navbarSupportedContent">
            ...
            <div class="row align-items-center">
                <div class="col-xl-5 offset-xl-7 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                    <div class="hero-content">
                        <h2 class="mb-30 wow fadeInUp" data-wow-delay=".2s">Test Header</h2>
                        <p class="wow fadeInUp" data-wow-delay=".4s">Test</p>
                        <div class="hero-btns">
            ...
            <div class="row mb-30">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-course wow fadeInUp" data-wow-delay=".2s">
                        <div class="course-img">
                            <a href="/">
                                <img src="/images/course/full-stack.jpg" alt="">
                            </a>
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-course wow fadeInUp" data-wow-delay=".6s">
                        <div class="course-img">
                            <a href="course-single.html">
                                <img src="/images/course/js.jpg" alt="">
                            </a>
                        </div>
                        <div class="course-info">
            ...
            <div class="row mb-30">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-course wow fadeInUp" data-wow-delay=".6s">
                        <div class="course-img">
                            <a href="course-single.html">
                                <img src="/images/course/python.jpg" alt="">
                            </a>
                        </div>
                        <div class="course-info">
            ...
            (function() {
                ...
                window.onscroll = function () {
                    ...
                    if (window.pageYOffset > sticky) {
                        header_navbar.classList.add("fixed");
                    } else {
                        header_navbar.classList.remove("fixed");
                    }
